...
namespace PlayerNS
{
    public class PlayerCamera : MonoBehaviour
    {
        ...
        {
            PlayerCamera playerCamera = Instantiate(Resources.Load<PlayerCamera>(ENV.PLAYER_RESOURCE_PREFAB_PATH + "Player Camera")).GetComponent<PlayerCamera>();
        ...
        // Instantiate
        public static PlayerCamera InstantiatePlayerCamera(GameMap gameMap)
        {
            PlayerCamera playerCamera = InstantiatePlayerCamera();
            playerCamera.SetGameMap(gameMap);
            return playerCamera;
        }
